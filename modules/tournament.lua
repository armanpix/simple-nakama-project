...
local function create_tournament(_context, payload)
 ...
 -- local id = nk.uuid_v4()
  ...
  nk.tournament_create(args.id, args.sort_order, args.operator, args.duration, args.reset_schedule, nil,
    args.title, args.description, args.category, args.start_time, args.end_time,nil, args.max_num_score, args.join_required)
